...
\hypersetup{
	...
	pdftitle = {Plataforma web para la descarga centralizada de software},
...
% Datos de portada
\title{Plataforma web para la descarga centralizada de software con gestión de bundles y búsqueda semántica mediante LLMs}
\author{\nombre}
\tutor{José Manuel Aroca Fernández, Rodrigo Pascual García}
\date{\today}
...
\noindent Que el alumno D. \nombre, con DNI 71478806G, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado Plataforma web para la descarga centralizada de software con gestión de bundles y búsqueda semántica mediante LLMs.
