...
\emph{software\_apps} & Nombre, slug único, descripción redactada manualmente por un usuario con permisos de administración, página oficial, icono, estado, creador y marcas temporales.\\
...
\emph{bundles} & Propietario opcional para oficiales, nombre, slug, descripción redactada manualmente por su autor o por un administrador, visibilidad, marca oficial, estado, contador de estrellas y marcas temporales.\\
...
\emph{software\_requests} & Solicitante, nombre, descripción propuesta manualmente por el usuario registrado, URL oficial propuesta, estado, respuesta administrativa y fechas.\\
