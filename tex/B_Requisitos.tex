...
RF-20 & Solicitar la incorporación de software indicando nombre, descripción y página oficial. & Media & Registrado\\
...
\begin{enumerate}
	...
	\item La descripción de una aplicación o de un bundle será un texto redactado manualmente por un usuario; el sistema no la generará ni la completará automáticamente.
...
\textbf{Flujo principal} & 1. Introduce nombre y una descripció.\newline
...
\subsection{CU-05b Solicitar una aplicación}
...
\toprule
\textbf{Actor} & Usuario registrado\\
\textbf{Requisitos} & RF-20\\
\textbf{Precondición} & El usuario ha iniciado sesión.\\
\textbf{Flujo principal} & 1. Introduce nombre, descripción redactada manualmente y página oficial de la aplicación propuesta.\newline
2. Envía la solicitud.\newline
3. El sistema la registra con estado pendiente de revisión.\\
\textbf{Excepciones} & Datos obligatorios ausentes, URL inválida o solicitud duplicada para la misma aplicación.\\
\textbf{Postcondición} & La propuesta queda disponible para revisión administrativa sin incorporarse todavía al catálogo público.\\
\bottomrule
\end{tabularx}
\caption{CU-05b Solicitar una aplicación.}
\label{tabla:cu-solicitar-aplicacion}
\end{table}
